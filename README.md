...
**常用的栈结构遍历二叉树需要O(h)的空间复杂度（h是二叉树的高度），而Morris遍历仅仅需要O(1)的空间复杂度**



**首先介绍寻找当前结点的前序结点的方法：**

1、如果该节点有左孩子，那么从左孩子开始，沿着右孩子指针一直想有走到底，得到的节点就是它的前序节点

2、如果左孩子的右节点指针是空，那么左孩子就是当前节点的前序节点。

3、如果当前节点没有左孩子，并且它是其父节点的右孩子，那么它的前序节点就是它的父节点

4、如果当前节点没有左孩子，并且它是父节点的左孩子，那么它没有前序节点，并且它自己就是首节点
